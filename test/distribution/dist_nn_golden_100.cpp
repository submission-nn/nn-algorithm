...
TEST(Dist_GoldenNearestNeighbor_100_10, Quadratic) {
	uint64_t pos1, pos2;
	NNList L1{1}, L2{1};
...
TEST(Dist_GoldenNearestNeighbor_100_10, Windowed) {
	...
	run_dist(gam, w , d, r, N, size, find_all, THRESHHOLD, 0, "w:100:0:10");
}

TEST(Dist_GoldenNearestNeighbor_100_10, WindowedWithEpsilon) {
	constexpr uint64_t w = 24;
	constexpr uint64_t d = 40;
	constexpr uint64_t r = 2;
	...
	run_dist(gam, w, d, r, N, size, find_all, THRESHHOLD, epsilon, "w:100:1:10");
}

TEST(Dist_GoldenNearestNeighbor_100_15, Windowed) {
	...
	run_dist(gam, w , d, r, N, size, find_all, THRESHHOLD, 0, "w:100:0:15");
}

TEST(Dist_GoldenNearestNeighbor_100_15, WindowedWithEpsilon) {
	constexpr uint64_t w = 24;
	constexpr uint64_t d = 40;
	constexpr uint64_t r = 2;
	constexpr uint64_t N = 358;
	...
	run_dist(gam, w , d, r, N, size, find_all, THRESHHOLD, epsilon, "w:100:1:15");
}


TEST(Dist_GoldenNearestNeighbor_100_20, Windowed) {
	...
	run_dist(gam, w , d, r, N, size, find_all, THRESHHOLD, 0, "w:100:0:20");
}

TEST(Dist_GoldenNearestNeighbor_100_20, WindowedWithEpsilon) {
	uint64_t pos1, pos2;
	NNList L1{1}, L2{1};
	...
	run_dist(gam, w , d, r, N, size, find_all, THRESHHOLD, epsilon, "w:100:1:20");
}
